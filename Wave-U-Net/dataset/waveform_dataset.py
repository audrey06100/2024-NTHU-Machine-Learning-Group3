...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, item):
        ...
        mixture, _ = librosa.load(os.path.abspath(os.path.expanduser(mixture_path)), sr=16000) #sr=None
        clean, _ = librosa.load(os.path.abspath(os.path.expanduser(clean_path)), sr=16000) #sr=None
